...
namespace UnitTests.ApplicationCore.Services.OrderServiceTests
{
    public class CreateOrder
    {
        ...
        private readonly IRepository<Order> _mocOrderRepo = Substitute.For<IRepository<Order>>();
        ...
        public async Task ThrowsEmptyBasketExceptionWhenBasketIsEmpty()
        {
            ...
            var orderService = new OrderService(basketService ,_mocOrderRepo);
            ...
            await Assert.ThrowsAsync<EmptyBasketException>(() => orderService.CreateOrderAsync(_buyerId, testAddress));
        }
    }
}
